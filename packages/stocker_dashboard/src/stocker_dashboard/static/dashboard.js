...
async function refresh() {
 ...
 try {
  ...
  if (s.opening_check && Object.keys(s.opening_check).length) html += table("Opening PAPER verification",[s.opening_check],["session","status","attempt","max_attempts","started_at","deadline","next_attempt_at","last_attempt_error","armed_at","error"]);
