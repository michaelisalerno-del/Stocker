...
async function runDetail(runId) {
  ...
  const selectionPanel = selection ? `<section class="section"><div class="section-head"><h2>Candidate selection</h2></div>
    ...
    <details><summary>Candidate diagnostics</summary><pre>${esc(JSON.stringify(selection, null, 2))}</pre>
    <a href="/api/runs/${encodeURIComponent(runId)}/candidate-selection?session=${encodeURIComponent(selection.session)}" target="_blank" rel="noopener">Inspect paginated scores, ranks and identities</a></details></section>` : "";
