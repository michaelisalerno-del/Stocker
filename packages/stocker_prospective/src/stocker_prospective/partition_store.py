...
def _event_type(event: RawEvent) -> str:
    names = {
        ...
        "ShadowBBOEvent": "underlying_bbo_update",
        "ShadowTradeEvent": "underlying_trade_update",
        "ShadowTradeStreamStateEvent": "optional_trade_stream_state",
        "ShadowGapEvent": "collection_gap_event",
