# Sequential Loop Competitor Veto V1
...
Primary paired rows: **8,670**. Sequential-minus-anchor Brier improvement was **0.035865** (session-block 95% interval 0.031153 to 0.040835); log-loss improvement was **0.099265**; probability-weighted paired economic increment was **-3071.86 bps**.

- 2023: n=4228, Brier improvement=0.033266, economic increment=-3172.45 bps
- 2025: n=4442, Brier improvement=0.038338, economic increment=100.59 bps

The negative-veto accounting keeps one immutable source row and never refills overlap/capacity. The full conservative veto avoided **1203285.59 bps** of losses and mistakenly rejected **1190968.51 bps** of profits, for **12317.08 bps** net veto value at **0.0%** coverage. This is a selection-only diagnostic on the original entry clock.

The static anchor good-to-bad odds veto produced **23678.94 bps** veto value at **92.9%** coverage. The identically thresholded sequential odds veto produced **8399.62 bps** at **97.5%**, an incremental **-15279.31 bps** over the anchor comparator.

The separate executable translation waits until causal admission, enters at the next provider open, and retains the original anchor-plus-24 terminal clock. It produced **0.00 bps** at **0.0%** coverage. Restarted-h24 payoff is exported only as a secondary table and is never mixed with constant-terminal payoff.
...
- cycle_04: cycle_10 (unknown), n=232, anchor mass=0.037, elimination rate=87.1%, median=4.0 bars
- cycle_04: cycle_08 (unknown), n=221, anchor mass=0.059, elimination rate=84.6%, median=4.0 bars
- cycle_04: cycle_06 (unknown), n=216, anchor mass=0.018, elimination rate=86.6%, median=4.0 bars
- cycle_04: cycle_06 (good), n=12, anchor mass=0.024, elimination rate=91.7%, median=5.0 bars
- cycle_04: cycle_08 (good), n=6, anchor mass=0.071, elimination rate=50.0%, median=7.0 bars
- cycle_07: cycle_11 (unknown), n=1416, anchor mass=0.058, elimination rate=84.0%, median=4.0 bars
- cycle_07: cycle_13 (unknown), n=1350, anchor mass=0.045, elimination rate=86.1%, median=5.0 bars
- cycle_07: cycle_13 (good), n=119, anchor mass=0.045, elimination rate=86.6%, median=4.0 bars
...
- loop: cycle_06, contribution=-4190.42 bps, absolute share=40.0%
- orientation: state_4, contribution=-2992.80 bps, absolute share=41.3%
- period: 2023, contribution=-3172.45 bps, absolute share=96.9%
- population: general_source, contribution=-4033.56 bps, absolute share=52.0%
- stock: QBTS, contribution=-2000.31 bps, absolute share=20.0%
...
Independent audit: **pending separate independent auditor**.

## 32–34. Scientific decision and recommendation

Scientific decision: **`competitor_posterior_not_payoff_informative`**.
