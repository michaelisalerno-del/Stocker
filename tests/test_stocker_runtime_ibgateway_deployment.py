...
RUNBOOK = ROOT / "docs/operations/stocker-v2-cutover.md"
SERVER_CONFIG = ROOT / "configs/runtime/recorder.example.json"
...
def test_record_only_server_template_uses_only_the_stocker_proxy_port() -> None:
    ...
    assert config["external_read_only_verified"] is True
    assert 7497 not in config.values()
